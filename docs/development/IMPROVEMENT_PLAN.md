...
- **Node-RED Requirement**: >=3 (updating to >=4)
- **Node.js Requirement**: >=18.5
- **Key Dependencies**: 
  - @openp4nr/modbus-serial v8.2.0 → @openp4nr/node-modbus >=v10
  - jsmodbus v4.0.10 should be removed and replaced by the new modbus server of @openp4nr/node-modbus
  - @xstate/fsm v2.1.0
