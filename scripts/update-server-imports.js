...
console.log('\nNOTE: The server package must be installed before running tests:')
console.log('  npm install')
console.log('\nIf the server package is not yet published, it will be installed from the local directory.')
