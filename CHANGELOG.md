...
* **client:** do not STOP shared Modbus-Client when one consumer is disabled/deleted ([#423](https://github.com/BiancoRoyal/node-red-contrib-modbus/issues/423), [#487](https://github.com/BiancoRoyal/node-red-contrib-modbus/issues/487))
* **client:** never block Node-RED deploy on hung `client.close` (safe close + ≤1.5s timeout)


### Features

* numbered learning-path examples (01–16) incl. shared-client disable demo (#423)


# [5.46.0](https://github.com/BiancoRoyal/node-red-contrib-modbus/compare/v5.45.1...v5.46.0) (2026-07-21)


### Bug Fixes

* buffer offset, test quality hardening, and Node 24 readiness for v5.46.0 ([bb8a465](https://github.com/BiancoRoyal/node-red-contrib-modbus/commit/bb8a465eb0d56679a918859586ad29c4d642b0c2))
* **ci:** open registry entry update ([6904806](https://github.com/BiancoRoyal/node-red-contrib-modbus/commit/6904806b2d463d835ff22e1f84f451931ac17ab1))
* **ci:** stabilize GitHub Actions tests for release builds ([af5f77d](https://github.com/BiancoRoyal/node-red-contrib-modbus/commit/af5f77d619cd55fb48d6da0df7ac3f5163fa6c30))
* **deps:** resolve @openp4nr/modbus-serial via npm.cloudsmith.io ([a2ec11e](https://github.com/BiancoRoyal/node-red-contrib-modbus/commit/a2ec11eb7eafb7490f0891e7d907a5062657fa45))
* **test:** avoid flaky second flex-write coverage flow load ([8d272d8](https://github.com/BiancoRoyal/node-red-contrib-modbus/commit/8d272d8a2fa8a506f14986569076d82adb81ded1))
* **test:** harden flex-write coverage against CI client timeouts ([3a621b4](https://github.com/BiancoRoyal/node-red-contrib-modbus/commit/3a621b4b22e78d724567240677c107cb2ee7011b))
* **test:** harden parallel CI against sinon pollution and port races ([0aaa8d7](https://github.com/BiancoRoyal/node-red-contrib-modbus/commit/0aaa8d761d668ed40d9df8cd2375946906d50b5e))
* **test:** stabilize flex-getter CI timeouts on slow runners ([cb3aa37](https://github.com/BiancoRoyal/node-red-contrib-modbus/commit/cb3aa373d47b5405ce8222f139649176dbb23f1e))
* **test:** stabilize flex-write coverage and queue-info CI tests ([979dbc9](https://github.com/BiancoRoyal/node-red-contrib-modbus/commit/979dbc9fb1ca73ecdb95e8ec136a96a020500a02))
* **test:** stabilize flex-write coverage under prepublish CI load. ([3eaf76c](https://github.com/BiancoRoyal/node-red-contrib-modbus/commit/3eaf76c340fc6a095cc01140a2e47f1c13384538))
* **test:** stabilize modbus-write E2E flows under parallel CI ([94ab798](https://github.com/BiancoRoyal/node-red-contrib-modbus/commit/94ab798ff1739bea2f875fa61b24c26397a1e6d9))
...
## [5.45.1](https://github.com/BiancoRoyal/node-red-contrib-modbus/compare/v5.45.0...v5.45.1) (2025-10-29)
...
## [5.44.1](https://github.com/BiancoRoyal/node-red-contrib-modbus/compare/5.44.1...v5.44.1) (2025-09-16)
...
# [5.23.0](https://github.com/BiancoRoyal/node-red-contrib-modbus/compare/v5.22.0...v5.23.0) (2022-08-01)
